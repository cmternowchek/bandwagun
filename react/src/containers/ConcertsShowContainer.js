...
class ConcertsShowContainer extends Component {
  ...
  componentDidMount(){
    ...
    render () {
      let roomsMap=`https://widget.alltherooms.com/widget/?key=111e36fffc103da97a9bf5f281c50cb0f6f7d0c9#schema=v1&location=${this.state.concert.venue_lat},${this.state.concert.venue_lng}&start_date=2017-10-13&primary_color=d41423&initial_zoom=15&tileset=hot`
        ...
        <div>
          ...
          <div className="row">
            ...
            <div className="iframe column">
              <iframe src={roomsMap} width="100%" height="750"></iframe>
            </div>
          </div>
        </div>
      )}
